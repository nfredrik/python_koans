...
class AboutTuples(Koan):
    ...
    def test_tuples_are_immutable_so_item_assignment_is_not_possible(self):
        ...
        try:
            ...
            self.assertMatch("'tuple' object does not support", ex[0])
    ...
    def test_tuples_of_one_look_peculiar(self):
        ...
        #self.assertEqual(---, ("Hello comma!", ))      #### What should we verify here???

    def test_tuple_constructor_can_be_surprising(self):
        self.assertEqual(('S','u','r','p','r','i','s','e','!'), tuple("Surprise!"))

    def test_creating_empty_tuples(self):
        self.assertEqual(tuple(), ())   ### What should we verify here???
